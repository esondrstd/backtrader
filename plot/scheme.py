...
class PlotScheme(object):
    def __init__(self):
        ...
        self.volup = 'lightgreen'  # 0.66 of gray
        # Default colour for the volume of a bearish day
        self.voldown = 'crimson'  # (204, 96, 115)
        ...
        # Wether indicators have a legend displaey in their charts
        self.legendind = True
        ...
        self.fmt_x_ticks = '%Y-%b-%d %H:%M'

        # strftime Format string for the display of data points values
        self.fmt_x_data = '%Y-%b-%d %H:%M'
