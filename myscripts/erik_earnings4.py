...
intraday_prices = Table('fundamentals',metadata,
	...
	Column('eps_estimate',Numeric(19,4), nullable=False),
	Column('eps_actual',Numeric(19,4), nullable=False),
	Column('eps_diff',Numeric(19,4), nullable=False),
