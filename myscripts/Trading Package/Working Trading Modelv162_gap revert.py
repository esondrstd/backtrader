...
class UserInputs():
	...
	def model_params():
		params = dict(
			...
			start_date = date(2018,4,1), #Dates for backtesting
...
class Strategy(bt.Strategy):
	...
	def __init__(self):
		...
		self.trade_end = int(10)*60 + int(30)	#Trade Entry End Hour and Minute
	...
	def next(self):
		...
		if self.hour < 11:
			for n in self.merged_dict.keys():
				...
				if self.hourmin >='08:45':  #Need sufficient number of bars to pass so you don't get stopped too early from stochastic
