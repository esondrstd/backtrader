...
#*********************************************INITITIALIZE INDICATORS*********************************************************				
				...
				self.inds[d._name]['obv'] = btind.obv(d,period=self.p.obv,plot=False)
				...
				self.inds[d._name]['perc_chg'] = btind.PercentChange(d.open,period=6,plot=True)
...
#**************************************************************************************************************************************
	...
	def pull_back(self,d):
		...
		print(self.dt, d._name, d.close[0],d.close[-1],d.close[-2],self.vwap_t0,np.array(d.close.get(ago=0,size=3))>self.vwap_t0)
