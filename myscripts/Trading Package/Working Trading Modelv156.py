...
#python -m cProfile "C:\Program Files\Python38\Lib\site-packages\backtrader\myscripts\Trading Package\Working Trading Modelv156.py"  #Type this in at command prompt to profile code, make sure to cd\ first
...
#**************************************************************************************************************************************
	...
	def next(self):
		...
		self.hourmin = self.datetime.datetime(ago=0).strftime('%H:%M')
