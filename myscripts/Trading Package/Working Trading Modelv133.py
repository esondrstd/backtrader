...
#**************************************************************************************************************************************
	...
	def create_pairs(self,d,signif):
		...
		for i, (ticker1, ticker2) in enumerate(all_pairs): 	
			...
			net_pair_val = t1_data[-1]*hedge_ratio_t1 + t2_data[-1]*hedge_ratio_t2  #think market price of "spread", just like price per share for any stock
	...
	def calc_spread_zscore(self,d,z_entry_threshold=2.0,z_exit_threshold=1):
		...
		for i in self.adfpval:
			...
			for list1_i, list2_i in zip_obj:  #subtract lists to get spread
				myspread = list1_i-list2_i  #******THIS SHOULD BE NET_PAIR_VAL**************
