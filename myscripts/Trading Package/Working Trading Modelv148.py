...
class UserInputs():
	...
	def datalist(data_req):
		...
		datalist = ['SPY','TICK-NYSE','AAPL','INTC','ACN','ADBE', 'AMZN', 'ANTM', 'ADI', 'AGN', 'ALGN', 'ALL', 'ALXN','WM','AGG','AMGN']
...
class Strategy(bt.Strategy):
	...
	def __init__(self):
		...
		#print(self.eps_dict)
		#print(self.eps_dict.get('INTC').get('date'))
		#print(self.eps_dict.get('INTC').get('eps_actual'))
		#print(self.eps_dict.get('INTC').get('eps_estimate'))
		#print(self.eps_dict.get('INTC').get('eps_diff%'))		
...
#**************************************************************************************************************************************
	...
	def tick_trade(self,direction):
		if self.tick_close[0] >= 200 and direction=='short':
			return True
		elif self.tick_close[0] <= -200 and direction=='long':
			return True
		else:
			return False
